...
assert(app.includes('Haltestege')&&app.includes('updateContourTabCount')&&app.includes('updateContourTabWidth')&&app.includes('updateContourTabHeight')&&app.includes('tabHeightMm'),'Bearbeiten UI exposes complete tab controls');
