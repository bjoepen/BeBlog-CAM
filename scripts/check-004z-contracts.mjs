...
requireText(planarRaster,'safePolyline(loops,candidate,radius,step,profile,pointFilter)','004Z-C validates every stay-down candidate with cutter-radius clearance while allowing optional stricter region ownership');
