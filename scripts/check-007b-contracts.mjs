...
if(safe.includes('surfaceCarveCanonicalToolpath')||preflight.includes('surfaceCarveCanonicalToolpath')||gcode.includes('surfaceCarveCanonicalToolpath')||post.includes('surfaceCarveCanonicalToolpath'))fail('007B adapter is coupled directly into protected production paths.');

console.log('007B contract PASS: surface projection still becomes canonical XYZ cuts plus explicit safe motions without coupling the adapter to 004T, preflight, NC or postprocessors.');
