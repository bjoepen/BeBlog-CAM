...
if(!process.exitCode){
  console.log('PASS 008B4 source-change contract: project source identity is verified before saved setup or operation state may be restored, so a same-named but changed CAD source cannot silently become a different machining job.');
}
