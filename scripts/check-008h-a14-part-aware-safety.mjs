...
need(a3,'curvedFaceTargetZAt(target,x,y)','selected target must still own cutter-centre machining intent');
need(a3,'partSafetyUpperZAt(partSafety,x+dx,y+dy)','cutter disk must use complete Part Safety Truth');
...
for(const source of [part,a3,a4,a6,a10,op])for(const forbidden of ['RoughingRegion','buildPlanarRasterChains','ballnoseContactAt'])forbid(source,forbidden,`forbidden geometry shortcut ${forbidden}`);
