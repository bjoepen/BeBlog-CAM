...
const required = [
  ...
  ['src/lib/modelRoughingToolpath.ts', ['profile?:ZLevelPerformanceProfile','buildPlanarRasterChains(loops,clearanceDiameterMm,stepoverPercent,profile']],
  ['src/lib/modelRoughingOperation.ts', ['profile?:ZLevelPerformanceProfile','profile.accessibilitySamples++','profile.accessibilityRegionTests++','sliceTrianglesAtZ(part,Math.max(b.minZ,cutZ-allowance),profile)']],
