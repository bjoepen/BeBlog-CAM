...
{#if result.ok}
  ...
  <div class="export-box"><div><strong>NC-Datei</strong><span>Speichert exakt den aktuell geprüften G-Code als .nc.</span></div><button class="primary-export" onclick={saveNc}>G-Code speichern …</button></div>
