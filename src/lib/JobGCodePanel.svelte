...
{#if result.ok}
  ...
  <div class="facts"><span>{result.operationCount} Bearbeitungen</span><span>{result.toolChangeCount} Werkzeugwechsel</span><span>{result.lineCount} G-Code-Zeilen</span></div>
  ...
  <div class="export-box"><div><strong>NC-Gesamtjob</strong><span>Speichert alle aktiven Bearbeitungen in Listenreihenfolge als eine .nc-Datei.</span></div><button class="primary-export" onclick={saveNc}>G-Code speichern …</button></div>
