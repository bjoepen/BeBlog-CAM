...
export type CanonicalToolpath={
  version:1;
  operationKind:'z-level-roughing'|'facing'|'contour'|'pocket'|'carve'|'surface-carve'|'drill'|'surface-finishing';
  strategy:'raster'|'zigzag'|'contour'|'concentric'|'parallel-pocket'|'carve'|'surface-carve'|'drill'|'helical-bore'|'parallel-surface';
