...
<p class="note"><strong>Grundregel:</strong> Werkzeugwege dürfen die Sollkontur niemals neu definieren. Die CAD-Koordinaten bestimmen das Bauteil; Radiuskorrektur, Zustellungen und G-Code werden daraus abgeleitet.</p>
