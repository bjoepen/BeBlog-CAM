...
function generateOperation(args:Args,operation:CamOperation):OperationCode{
  ...
  if(operation.kind==='3d-roughing')return{ok:false,errors:['3D Schruppen wird ausschließlich aus der durch Preflight und 004T freigegebenen Canonical-Motion-Wahrheit als Gesamtjob ausgegeben.'],warnings:[],code:''};
